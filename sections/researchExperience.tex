...
\outerlist{
	...
	\innerlist{
		\entry{Nonlinear model reduction: \textcolor{color-detail}{developing scalable algorithms for implementing nonlinear balanced truncation model reduction.}}
		\entry{Nonlinear control: \textcolor{color-detail}{researching numerical approximations to optimal control laws based on Taylor series expansions. }}
	}
	...
	\innerlist{
		\entry{Ran experiments using tools including high speed imagery, particle image velocimetry, 3D-printing, and processed data using \textsc{Matlab}, Mathematica, and FFMPEG.}
	}
}