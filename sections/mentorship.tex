...
\outerlist{
	\entrybig
	{\textbf{UCSD Students for the Exploration and Development of Space mentor}}{La Jolla, CA}
	{Student mentor}{July 2024\textendash  Present}
	\innerlist{
		\entry{Providing mentorship to UCSD SEDS rocketry team, which is working towards a self-landing liquid propellant rocket. Working with undergraduate engineers to help with problem definition, design requirements, component analysis and testing strategies, and rocket attitude control design.}
	}
	\entrybig
	{\textbf{UCSD undergraduate research mentor}}{La Jolla, CA}
	{Student mentor}{June 2022\textendash  September 2022}
	\innerlist{
		\entry{Mentored undergraduate researcher Antoinette Gautier under the supervision of Dr. Kramer. Worked with Antoinette to compile SOFA soft robotics finite element software in Linux and implement open- and closed-loop control in SOFA. }
	}
	\entrybig
	{\textbf{Virginia Tech ESM senior design advisor}}{Blacksburg, VA}
	{Team sponsor/advisor}{August 2020\textendash  May 2021}
	\innerlist{
		\entry{Sponsored and mentored a senior design team through UpStream Services LLC startup to develop innovative waste-measurement device. }
	}
	\entrybig
